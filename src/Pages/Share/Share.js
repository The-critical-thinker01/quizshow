...
const Share = () => {
    ...
    const link = `http://localhost:3000/quiz/${id}`
        ...
        <div className="flex w-full justify-center p-4 bg-yellow-300 min-h-screen">
            <div className="flex flex-col w-3/4 p-4 bg-white rounded-lg">
                    ...
                    <div className="w-full flex flex-col flex-wrap justify-center border-b p-4">
                        <div className="flex justify-between">
                            ...
                            <div className="flex space-x-2">
                                <button onClick={() => { navigate(`/questionsboard/${id}`) }} className="p-3  bg-green-400 shadow-slate-700 shadow-md text-lg hover:bg-slate-100 rounded-2xl ">
                                    Questions
                                </button>
                ...
                <div className="flex p-5 justify-around">
                    <input value={link} className="p-4 border-2 rounded-lg w-1/2 outline-none" />
                    <button onClick={() => {navigator.clipboard.writeText(link); alert("Link copied")}} className="p-3 w-1/3 bg-green-400 shadow-slate-700 shadow-md text-lg hover:bg-slate-100 rounded-2xl ">
                        Copy Link
                    </button>
                </div>
