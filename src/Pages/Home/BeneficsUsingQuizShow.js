  ...
  return (
    <div className=" flex flex-col mt-9">
      <div className=" flex justify-center items-center w-full">
        <h1 className="text-5xl text-yellow-500 mt-12 mb-5">
          Benefits of having Quizzes with QuizShow!
        </h1>
      </div>

      <div className="justify-center items-center grid grid-cols-3 gap-x-3 gap-y-6  m-3 px-7 py-10">
        <div className="flex flex-col justify-center items-center">
          <img className="w-2/5 mr-2  " src={happy} alt="Happy" />
          <h2 className="my-6 text-5xl text-yellow-500">Be Proud</h2>
          <p className=" px-4 ">
        ...
        <div className="flex flex-col  justify-center items-center">
          ...
          <h2 className="my-6 text-5xl text-yellow-500">Stay Focus</h2>
          <p>Boredom is reduced and effective learning increases</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <img className="w-2/5 mr-2  " src={Tools} alt="Tools" />
          <h2 className="my-6 text-5xl text-yellow-500">Discovering Tools</h2>
