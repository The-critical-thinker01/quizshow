    ...
    <div className=" flex flex-col">
      ...
      <div className="justify-center items-center grid grid-cols-3 gap-x-3 gap-y-6  m-3 px-7 py-10">
        <div className="flex flex-col justify-center items-center">
          <img className="w-2/5 mr-2  " src={creati} alt="workspace" />
          <h2 className="my-6 text-5xl text-yellow-500">Create</h2>
          <p className=" px-4 ">
        ...
        <div className="flex flex-col  justify-center items-center">
          ...
          <h2 className="my-6 text-5xl text-yellow-500">Host or share</h2>
          <p>
