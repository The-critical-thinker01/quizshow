  ...
  return (
    <div className="flex w-full justify-center  bg-yellow-300 ">
      <div className="flex flex-col w-3/4 justify-center items-center">
        ...
        <button className="flex flex-col md:flex-roww-full w-full md:w-5/6 mt-3 mb-3 bg-cyan-400 shadow-slate-700 shadow-md text-5xl hover:bg-slate-100 h-32 md:h-20 rounded-2xl ">
          {Quiz.name}
        </button>
        <div className=" flex w-2/6 p-3 justify-center items-center rounded-full bg-slate-400">
          <img
